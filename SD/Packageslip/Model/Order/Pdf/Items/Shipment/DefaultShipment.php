<?php
namespace SD\Packageslip\Model\Order\Pdf\Items\Shipment;
...
class DefaultShipment extends \Magento\Sales\Model\Order\Pdf\Items\Shipment\DefaultShipment {
 /**
    ...
    public function draw()
    {
        ...
        $cat = $this->category->create()->load($categoryId);
        if ($categoryId != 2) {
           $cateName[] =  $cat->getName();
        }
        ...
        $lines[0][] = [
                ...
                // phpcs:ignore Magento2.Functions.DiscouragedFunction
                'text' => $this->string->split(html_entity_decode(implode(' | ', $cateName)), 60, true, true),
                'feed' => 420,
                'align' => 'right',
